...
class Allosaurus(Combatant):
    def __init__(self, team):
        super().__init__("Allosaurus", 12, 42, 2, team, [Attack("Bite",lambda r: r+6, MakeHit(lambda: R(2,10)+4), MakeHit(lambda: R(4,10)+4)), Attack("Claw",lambda r: r+6, MakeHit(lambda: R(1,8)+4), MakeHit(lambda: R(2,8)+4))])
